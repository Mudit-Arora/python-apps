...
setup(
  name = 'invoicing-basic',         #* Your package will have this name
  ...
  author = 'Mudit Arora',                   # Your name
  author_email = 'muditarora31@gmail.com',  # Your email
  url = 'https://muditarora.vercel.app/',              # Homepage of your library (e.g. github or your website)
